 ...
 * Note that if you want to use Shift with selmasks, set this to an other
...
#define TERMMOD (ControlMask|Shift)
...
static Shortcut shortcuts[] = {
        ...
        {Alt | ControlMask,         XK_l, externalpipe, {.v = openurlcmd}},
        ...
        {Shift,       XK_U,         kscrollup,     {.i = 1}},
        {Shift,       XK_D,         kscrolldown,   {.i = 1}},
        {Shift,       XK_Page_Up,   kscrollup,     {.i = -1}},
        {Shift,       XK_Page_Down, kscrolldown,   {.i = -1}},
};
...
static Key key[] = {
        ...
        {XK_Up,            Shift | ControlMask,       "\033[1;6A", 0, 0},
        {XK_Up,            ControlMask | Alt,         "\033[1;7A", 0, 0},
        {XK_Up,            Shift | ControlMask | Alt, "\033[1;8A", 0, 0},
        ...
        {XK_Down,          Shift | ControlMask,       "\033[1;6B", 0, 0},
        {XK_Down,          ControlMask | Alt,         "\033[1;7B", 0, 0},
        {XK_Down,          Shift | ControlMask | Alt, "\033[1;8B", 0, 0},
        ...
        {XK_Left,          Shift | ControlMask,       "\033[1;6D", 0, 0},
        {XK_Left,          ControlMask | Alt,         "\033[1;7D", 0, 0},
        {XK_Left,          Shift | ControlMask | Alt, "\033[1;8D", 0, 0},
        ...
        {XK_Right,         Shift | ControlMask,       "\033[1;6C", 0, 0},
        {XK_Right,         ControlMask | Alt,         "\033[1;7C", 0, 0},
        {XK_Right,         Shift | ControlMask | Alt, "\033[1;8C", 0, 0},
